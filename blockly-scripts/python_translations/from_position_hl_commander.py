...
class BlocklyPosition:
    ...
    def get_a_position(self, which: which, name: coordinates):
        if which == which.CURRENT:
            ...
            elif name == coordinates.y:
                return PositionHlCommander._y
            elif name == coordinates.z:
                return PositionHlCommander._z
            else:
                print("Error: unknown coordinate")
        elif which == which.DEFAULT:
            if name == coordinates.z:
                return PositionHlCommander._default_height
            else:
    ...
    def move(self, direction: direction, distance: float, speed=PositionHlCommander.DEFAULT):
        if direction == direction.left:
            ...
            PositionHlCommander.right(distance, speed)
        elif direction == direction.forward:
            PositionHlCommander.forward(distance, speed)
        elif direction == direction.backward:
            PositionHlCommander.back(distance, speed)
        else:
